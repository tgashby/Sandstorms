...
//  Sandstorms
//
//  Created by Taggart Ashby on 8/27/12.
//
//
...
void GameState::generatePlatforms( Level* lvl, std::string platformTex, int platWidth, int platHeight )
{
...
void GameState::placeConsumables(Level *lvl, int numHPickups, int numMPickups, int numArtifacts, std::string artifactTex, int artifactHeight)
{
...
void GameState::placeEnemies(Level *lvl, int numHounds, int numWarriors, int numCasters)
{
